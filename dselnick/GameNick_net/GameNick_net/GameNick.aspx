...
<head runat="server">
	...
	<script type="text/javascript">
		...
		window.LoginComplete = function (value) {
			if (window.loginDialog != null) {
				window.loginDialog.close();
			}
			getSlPlugin().LoginComplete(value);
		};
	</script>
	<script type="text/javascript">
...
<body>
	...
	<div id="silverlightControlHost">
		<object id="silverlightFacebook" data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">
		  <param name="source" value="ClientBin/release/GameNick_Web.xap"/>
